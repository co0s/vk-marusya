...
import { selectUser, selectIsAuthenticated, selectFavoriteMovies, logoutUser, checkAuth, fetchFavorites } from '../../store/slices/userSlice';
...
const UserPage: React.FC = () => {
  ...
  // Загружаем избранное при успешной авторизации
  useEffect(() => {
      ...
      {favoriteMovies.length === 0 ? (
        ...
        <div className={styles.movies__grid}>
          {favoriteMovies.map((movie, index) => (
            <div key={`favorite-${movie.id}-${index}`} className={styles.movie__card}>
